...
export default function FileEntry({ entry }) {
    ...
    const writeMetadata = useCallback(async (data) => {
        try {
    ...
    const onDelete = useCallback(async () => {
        ...
        try {
            ...
            const updatedMetadata = metadataArray.filter(m => m.hash !== entry.hash);
    ...
    }, [entry.hash, entry.name, folderHandle, metadataArray, setMetadataArray, writeMetadata, previewUrl, setErrorMsg]);
